  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            {(["ALL", "PURCHASE", "SALE"] as const).map((opt) => (
              <button
                ...
                style={{
                  ...
                  color:
                    filter === opt ? "var(--text-main)" : "var(--text-muted)",
                  boxShadow:
                    filter === opt ? "0 4px 6px -1px rgba(0,0,0,0.05)" : "none",
                }}
              >
                {opt === "ALL"
                  ? t("common.all") || "All Bills"
                  : opt === "PURCHASE"
              ...
              {loading ? (
                ...
                bills.map((bill) => (
                  ...
                  >
                    ...
                    <TableCell className="text-right font-bold text-[14px] text-gray-900 tabular-nums border-r border-gray-200 bg-amber-50/20">
                      {bill.status === "PENDING" ? (
                        <>
                    ...
                    >
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <ChevronRight
                          size={14}
                          className="text-gray-300 group-hover:text-blue-500 transition-colors inline"
                        />
                      </div>
                    </TableCell>
                  </TableRow>
                            ...
                            style={{
                              ...
                              backgroundColor:
                                bill.status === "PAID"
                                  ...
                                  : "rgba(245, 158, 11, 0.1)",
                              color:
                                bill.status === "PAID" ? "#15803d" : "#b45309",
                              borderColor:
                                bill.status === "PAID"
                                  ? "rgba(34, 197, 94, 0.2)"
                                  : "rgba(245, 158, 11, 0.2)",
      ...
      <ConfirmModal
        ...
        message="This will record a payment for the full bill amount and update the party balance. This action cannot be undone."
