...
export default function CustomerLedgerPage() {
  ...
  const outstandingBalance = customer ? Number(customer.balance) : 0;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      >
        <div
          ...
          style={{
            padding: "1.75rem",
            borderLeft: `4px solid ${balance > 0 ? "#dc2626" : "#15803d"}`,
          }}
        >
          <div
            style={{
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: "10px",
                backgroundColor:
                  balance > 0 ? "rgba(220,38,38,0.08)" : "rgba(21,128,61,0.08)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
          ...
          >
            {balance > 0
              ? t("ledger.customerOwes") || "Customer owes you"
                        ...
                        <div>
                          <p className="text-[13px] font-bold text-gray-900 leading-tight">
                            {entry.type === "BILL" ? (
                              <Link
                                href={`/bills/${entry.id}`}
                                className="text-blue-700 hover:underline decoration-1 underline-offset-4"
                              >
                    ...
                    <div style={{ textAlign: "right" }}>
                      <p
                        style={{
                          ...
                          fontSize: "14px",
                          fontWeight: 900,
                          color: entry.type === "BILL" ? "#dc2626" : "#15803d",
                        }}
                      >
                        {entry.type === "BILL"
                          ? `+${fmt(entry.debit)}`
                      ...
                      <p
                        style={{
                          ...
                          fontWeight: 800,
                          color:
                            entry.runningBalance > 0 ? "#dc2626" : "#15803d",
                        }}
                      >
