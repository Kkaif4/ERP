...
export default function ItemsPage() {
  ...
  const [formData, setFormData] = useState({
    name: "",
    defaultPricingMode: "WEIGHT" as "WEIGHT" | "WEIGHT_KG" | "UNIT",
  });
  ...
  const toggleActive = async (item: Item) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(
          item.isActive
            ? t("master.items.deactivated") || "Item deactivated"
            : t("master.items.activated") || "Item activated",
        );
      ...
      >
        <div>
          ...
          >
            ...
            >
              <Clock size={12} /> {activeCount}{" "}
              {t("master.items.activeItems") || "Active Items"} · {today}
            </p>
          </div>
        </div>
        {isAdmin && (
      ...
      <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
          ...
          >
            ...
            />
            <span
              style={{ fontSize: "12px", fontWeight: 800, color: "#7c3aed" }}
            >
              {activeCount} {t("master.items.active") || "Active"}
            </span>
          </div>
          {inactiveCount > 0 && (
            <div
            ...
            >
              ...
              />
              <span
                style={{ fontSize: "12px", fontWeight: 800, color: "#94a3b8" }}
              >
                {inactiveCount} {t("master.items.inactive") || "Inactive"}
              </span>
            </div>
          )}
        </div>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: showInactive
                ...
                : "transparent",
              border: `1.5px solid ${showInactive ? "rgba(124,58,237,0.2)" : "#e2e8f0"}`,
              borderRadius: "12px",
              fontSize: "12px",
              fontWeight: 800,
              color: showInactive ? "#7c3aed" : "#94a3b8",
              cursor: "pointer",
              transition: "all 0.2s",
            }}
          >
          ...
          {filtered.map((item) => (
            ...
            >
              ...
              >
                ...
                >
                  {item.defaultPricingMode === "WEIGHT" ? (
                    <Scale size={20} />
                  ) : item.defaultPricingMode === "WEIGHT_KG" ? (
                    <Scale size={20} />
                  ) : (
                    <Boxes size={20} />
                  )}
                    ...
                    color:
                      item.defaultPricingMode === "WEIGHT"
                        ...
                        : item.defaultPricingMode === "WEIGHT_KG"
                          ? "#d97706"
                          : "#15803d",
                    border: `1px solid ${item.defaultPricingMode === "WEIGHT" ? "rgba(14,165,233,0.2)" : item.defaultPricingMode === "WEIGHT_KG" ? "rgba(217,119,6,0.2)" : "rgba(21,128,61,0.2)"}`,
                  }}
                >
                  {item.defaultPricingMode === "WEIGHT"
                    ? "per 10 KG"
              ...
              >
                ...
                >
                  {item.isActive
                    ? t("master.items.active") || "Active"
                    : t("master.items.inactive") || "Inactive"}
                </span>
                {isAdmin && (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor:
                        togglingId === item.id ? "not-allowed" : "pointer",
                      fontSize: "10px",
                      fontWeight: 800,
                      backgroundColor: item.isActive
                        ? "#fef2f2"
                  ...
                  >
                    {togglingId === item.id ? (
                      ...
                      <>
                        <ToggleRight size={12} />{" "}
                        {t("master.items.deactivate") || "Disable"}
                      </>
                    ) : (
                      <>
                        <ToggleLeft size={12} />{" "}
                        {t("master.items.activate") || "Enable"}
                      </>
                    )}
                  </button>
                )}
              ...
              <div style={{ display: "flex", gap: "0.5rem" }}>
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 800,
                    color:
                      pagination.page === 1 ? "#cbd5e1" : "var(--text-main)",
