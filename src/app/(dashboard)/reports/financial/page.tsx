...
export default function FinancialReportsPage() {
  ...
  const reportTypes = [
    {
      ...
      label: t("reports.types.OUTSTANDING_PAYABLES"),
      icon: Users,
      color: "#b45309",
    },
    {
      id: "OUTSTANDING_RECEIVABLES",
      label: t("reports.types.OUTSTANDING_RECEIVABLES"),
      icon: UserSearch,
      color: "#dc2626",
    },
  ];
    ...
    ? [
        {
          label:
            reportType === "OUTSTANDING_PAYABLES"
              ? t("reports.types.OUTSTANDING_PAYABLES")
              : t("reports.types.OUTSTANDING_RECEIVABLES"),
  ...
  const handleDownloadPDF = () => {
    ...
    const reportLabel =
      reportTypes.find((r) => r.id === reportType)?.label || "Financial Report";
    let html = "";
