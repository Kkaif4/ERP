...
export default function OperationalReportsPage() {
  ...
  const reportTypes = [
    {
      id: "FARMER_PURCHASE",
      label: t("reports.types.FARMER_PURCHASE"),
      icon: User,
      color: "#15803d",
    },
    {
      id: "CUSTOMER_SALE",
      label: t("reports.types.CUSTOMER_SALE"),
      icon: ShoppingCart,
      color: "#0369a1",
    },
    {
      id: "PAYMENT_HISTORY",
      label: t("reports.types.PAYMENT_HISTORY"),
      icon: CreditCard,
      color: "#7c3aed",
    },
    {
      id: "EXPENSE_REPORT",
      label: t("reports.types.EXPENSE_REPORT"),
      icon: FileText,
      color: "#e11d48",
    },
    {
      id: "DAILY_SUMMARY",
      label: t("reports.types.DAILY_SUMMARY"),
      icon: BarChart3,
      color: "#ea580c",
    },
  ];
    ...
    switch (reportType) {
      ...
      case "CUSTOMER_SALE":
        return [
          ...
          {
            key: "totalUnits",
            label: t("reports.table.qtyUnits"),
            align: "right" as const,
            render: (v: number) => v?.toFixed(2) || "0.00",
          },
          {
            ...
            render: (v: number, item: any) => (
              <div className="text-right">
                <div className="text-[14px] font-bold text-[#475569] tabular-nums">
            ...
            pdfValue: (v: number, item: any) =>
              `₹ ${(v || 0).toLocaleString("en-IN")} ${item.othersNote ? "(" + item.othersNote + ")" : ""}`,
          },
          {
            key: "amount",
  ...
  const stats = summary
    ? [
        ...
        },
        {
          ...
          value: summary.count || summary.billsCount,
          icon: FileText,
          color: "#0369a1",
          isCurrency: false,
        },
              ...
              >
                <div
                  style={{
                    ...
                    height: "32px",
                    backgroundColor:
                      reportType === type.id ? type.color : "#e2e8f0",
                    borderRadius: "8px",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
        ...
        >
          ...
          >
            ...
            >
              <Download size={16} />{" "}
              <span className="button-text-hide">PDF</span>
            </button>
          </div>
        </div>
