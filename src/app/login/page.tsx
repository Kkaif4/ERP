...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          language === "mr" ? "यशस्वीरीत्या लॉगिन झाले!" : "Login Successful!",
        );
    ...
    >
      ...
      <div
        style={{
          ...
          height: "400px",
          background:
            "radial-gradient(ellipse at center, rgba(21,128,61,0.12) 0%, transparent 70%)",
          borderRadius: "50%",
          pointerEvents: "none",
          filter: "blur(40px)",
        }}
      ...
      >
          ...
          >
            <div
              style={{
                ...
                justifyContent: "center",
                boxShadow:
                  "0 8px 32px rgba(21,128,61,0.12), 0 2px 8px rgba(0,0,0,0.06)",
        ...
        >
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    color: "#0f172a",
                    backgroundColor:
                      focusedField === "username" ? "#fff" : "#f8fafc",
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    color: "#0f172a",
                    backgroundColor:
                      focusedField === "password" ? "#fff" : "#f8fafc",
          ...
          <div style={{ textAlign: "center", marginTop: "1.5rem" }}>
            ...
            >
              ...
              >
                {language === "mr" ? "नोंदणी करा" : "Register Admin"}
              </Link>
            </p>
          </div>
        ...
        {/* Footer */}
        <footer
          style={{ textAlign: "center", marginTop: "2rem", opacity: 0.4 }}
        >
          <p
            style={{
              fontSize: "10px",
